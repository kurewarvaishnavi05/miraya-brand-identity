...
export default function ShopPage() {
  return (
    <div className="flex flex-col w-full min-h-screen bg-miraya-white pt-32">
      {/* Simple Shop Header */}
      <div className="text-center px-4 mb-12">
        <h1 className="text-4xl md:text-5xl font-serif text-miraya-black mb-4">
          The Collection
        </h1>
        <div className="h-1 w-16 bg-miraya-gold mx-auto" />
      </div>

      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 w-full">
        {/* Breadcrumb */}
        <div className="flex items-center text-sm text-miraya-black/60 mb-8 pb-8 border-b border-miraya-black/10">
          <span>Home</span>
          <ChevronRight size={14} className="mx-2" />
          <span className="text-miraya-black font-medium">Shop All</span>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between items-center mb-8">
              <span className="text-sm text-miraya-black/60">Showing 1-12 of 124 products</span>
